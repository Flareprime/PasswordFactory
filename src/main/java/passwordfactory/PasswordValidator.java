/*
    ...
    Description:
    This class implements the PasswordChecker interface and validates passwords
    (eventually) based on length, character diversity, and common password patterns
...
//Validates passwords based on length, character diversity, and common password checks
 public class PasswordValidator implements PasswordChecker
{
