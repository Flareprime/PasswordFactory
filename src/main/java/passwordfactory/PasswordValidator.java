/*  Jordan Bassett & Lizbeth Garcia-Lopez
    ...
    Desc: This class extends PasswordComponent and implements the PasswordChecker interface.
...
//Validates passwords based on length, character diversity, and common password patterns
public class PasswordValidator extends PasswordComponent
{
    //List of common weak words that should be avoided in passwords (to be expanded)
    ...
    public int checkStrength(String password)
    {
        ...
        for (char c : password.toCharArray())  //go through string looking for the above
        {
